...
!(function (t, e) {
    ...
    return (
      ...
      (t.to = function (t) {
        ...
        if (!(t > this._items.length - 1 || t < 0)) {
          if (this._isSliding) g(this._element).one(Y.SLID, () => e.to(t));
          else {
      ...
      (t._addEventListeners = function () {
        ...
        this._config.keyboard
                    && g(this._element).on(Y.KEYDOWN, (t) => e._keydown(t)),
        this._config.pause === 'hover'
                        && g(this._element)
                          .on(Y.MOUSEENTER, (t) => e.pause(t))
                          .on(Y.MOUSELEAVE, (t) => e.cycle(t)),
      ...
      (t._addTouchEventListeners = function () {
        ...
        if (this._touchSupported) {
          ...
          this._pointerEvent
            ? (g(this._element).on(Y.POINTERDOWN, (t) => n(t)),
            g(this._element).on(Y.POINTERUP, (t) => i(t)),
            this._element.classList.add(et))
            : (g(this._element).on(Y.TOUCHSTART, (t) => n(t)),
            g(this._element).on(Y.TOUCHMOVE, (t) => (function (t) {
              t.originalEvent.touches
                                      && t.originalEvent.touches.length > 1
                ? (e.touchDeltaX = 0)
                : (e.touchDeltaX = t.originalEvent.touches[0]
                  .clientX - e.touchStartX);
            }(t))),
            g(this._element).on(Y.TOUCHEND, (t) => i(t)));
        }
      }),
      ...
      (t.show = function () {
        ...
        if (
          !this._isTransitioning
                    ...
                    && (this._parent
                        && (t = [].slice
                          ...
                          .filter((t) => (typeof n._config.parent === 'string'
                            ? t.getAttribute('data-parent')
                                      === n._config.parent
                            : t.classList.contains(Et)))).length === 0
                        && (t = null),
                    !(
                      t
          ...
          if (
            ...
            const s = _.getTransitionDurationFromElement(
              this._element,
            );
            g(this._element)
              .one(_.TRANSITION_END, () => {
      ...
      (t.hide = function () {
        ...
        if (!this._isTransitioning && g(this._element).hasClass(yt)) {
          ...
          if (
            ...
            this.setTransitioning(!0);
            this._element.style[n] = '';
            const a = _.getTransitionDurationFromElement(
              this._element,
            );
            g(this._element)
              .one(_.TRANSITION_END, () => {
  ...
  const ee = (function () {
    ...
    return (
      ...
      (c._clearMenus = function (t) {
        if (
          !t
                    || (t.which !== 3 && (t.type !== 'keyup' || t.which === 9))
        ) {
          for (
            ...
            if (
              (t && t.type === 'click' && (s.clickEvent = t), r)
            ) {
              const a = r._menu;
              if (
                g(o).hasClass(Rt)
  ...
  const Te = (function () {
    ...
    return (
      ...
      (t.show = function (t) {
        ...
        if (!this._isShown && !this._isTransitioning) {
          ...
          this._isShown
                            ...
                            g(this._element).on(le.CLICK_DISMISS, ye, (t) => e.hide(t)),
                            g(this._dialog).on(le.MOUSEDOWN_DISMISS, () => {
                              g(e._element).one(le.MOUSEUP_DISMISS, (t) => {
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              const o = _.getTransitionDurationFromElement(
                this._element,
              );
              g(this._element)
      ...
      (t.dispose = function () {
        [window, this._element, this._dialog].forEach((t) => g(t).off(oe)),
        g(document).off(le.FOCUSIN),
      ...
      (t._setEscapeEvent = function () {
        ...
        this._isShown && this._config.keyboard
          ? g(this._element).on(le.KEYDOWN_DISMISS, (t) => {
      ...
      (t._setResizeEvent = function () {
        const e = this;
        this._isShown
          ? g(window).on(le.RESIZE, (t) => e.handleUpdate(t))
      ...
      (t._showBackdrop = function (t) {
        ...
        if (this._isShown && this._config.backdrop) {
          if (
            ...
            g(this._element).on(le.CLICK_DISMISS, (t) => {
          ...
          if (!n) return void t();
          const i = _.getTransitionDurationFromElement(
            this._backdrop,
          );
          g(this._backdrop)
          ...
          if (g(this._element).hasClass(de)) {
            const r = _.getTransitionDurationFromElement(
              this._backdrop,
            );
            g(this._backdrop)
              .one(_.TRANSITION_END, o)
  ...
  const Ie = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i;
  function we(t, r, e) {
    ...
    for (
      var n = new window.DOMParser().parseFromString(t, 'text/html'),
        ...
        i = function (t) {
          ...
          if (s.indexOf(e.nodeName.toLowerCase()) === -1) return e.parentNode.removeChild(e), 'continue';
    ...
    return (
      ...
      (t.show = function () {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          const s = typeof this.config.placement === 'function'
      ...
      (t._setListeners = function () {
        ...
        this.config.trigger.split(' ').forEach((t) => {
          if (t === 'click') {
            ...
            g(i.element)
              .on(e, i.config.selector, (t) => i._enter(t))
              .on(n, i.config.selector, (t) => i._leave(t));
          }
        }),
      ...
      (t._enter = function (t, e) {
        ...
        t
                        && (e._activeTrigger[t.type === 'focusin' ? Ve : Be] = !0),
      ...
      (t._leave = function (t, e) {
        ...
        (e = e || g(t.currentTarget).data(n))
                    ...
                    g(t.currentTarget).data(n, e)),
        t
                        && (e._activeTrigger[t.type === 'focusout' ? Ve : Be] = !1),
  ...
  const On = (function () {
    function n(t, e) {
      ...
      g(this._scrollElement).on(pn.SCROLL, (t) => n._process(t)),
      this.refresh(),
      this._process();
    }
    const t = n.prototype;
    return (
      ...
      (t._activate = function (e) {
        ...
        const t = this._selector
          .split(',')
          .map((t) => `${t}[data-target="${e}"],${t}[href="${e}"]`);
        const n = g(
    ...
    return (
      (t.show = function () {
        ...
        if (
          ...
          if (e) {
            const r = e.nodeName === 'UL' || e.nodeName === 'OL'
              ? Kn
              : Mn;
            i = (i = g.makeArray(g(e).find(r)))[i.length - 1];
          }
          const s = g.Event(jn.HIDE, {
  ...
  const si = (function () {
    ...
    return (
      ...
      (t._setListeners = function () {
        const t = this;
        g(this._element).on(Jn.CLICK_DISMISS, ri, () => t.hide());
      }),
      (t._close = function () {
        function t() {
        ...
        var e = this;
        if (
          (this._element.classList.remove(ei), this._config.animation)
        ) {
          const n = _.getTransitionDurationFromElement(this._element);
          g(this._element)
            .one(_.TRANSITION_END, t)
      ...
      (i._jQueryInterface = function (n) {
        return this.each(function () {
          ...
          if (
            (e
                            || ((e = new i(this, typeof n === 'object' && n)),
                            t.data(Xn, e)),
            typeof n === 'string')
          ) {
            if (typeof e[n] === 'undefined') throw new TypeError(`No method named "${n}"`);
